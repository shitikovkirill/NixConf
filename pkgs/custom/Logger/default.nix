...
in stdenv.mkDerivation rec {
  ...
  src = pkgs.fetchurl {
    url =
      "https://github.com/tmoreno/open-log-viewer/releases/download/1.0.0/open-log-viewer_1.0.0.deb";
    sha256 = "118ml54jvipfcwjsp2glzj33wrp1bqmc91msf6vsbpp67hfl4iqc";
  };

  icon = pkgs.fetchurl {
    url =
      "https://raw.githubusercontent.com/tmoreno/open-log-viewer/master/docs/img/logo.png";
