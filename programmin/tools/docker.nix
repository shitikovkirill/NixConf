...

{
  ...
  environment.shellAliases = {
    ...
    azurite =
      "docker run --rm --name=azurite --log-driver=journald -p '0.0.0.0:10000:10000' -p '0.0.0.0:10001:10001' -v 'azurite_blob:/data' mcr.microsoft.com/azure-storage/azurite";
  };
}
